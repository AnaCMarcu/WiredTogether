...
Subcommands (see docs in each stage function):
    ...
    sample    stratified batch files for in-session LLM annotation
...
Usage:
    python analysis/qualitative/run.py parse --only exp08_llm_9b_social_prompt/seed_42
    python analysis/qualitative/run.py parse
    python analysis/qualitative/run.py metrics
"""
