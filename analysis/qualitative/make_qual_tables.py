...
(``analysis/qualitative/out/tables/``) and emits, per condition, the
...
Outputs (into --out, default paper_assets/medium_ext/):
...
Usage:
  python analysis/qualitative/make_qual_tables.py
  python analysis/qualitative/make_qual_tables.py --tables DIR --out DIR
"""
...
def main() -> int:
    ...
    ap.add_argument("--out", type=Path, default=REPO / "paper_assets/medium_ext",
    ...
    (args.out / "qual_table_rows.tex").write_text(
        "% Generated by analysis/qualitative/make_qual_tables.py\n"
