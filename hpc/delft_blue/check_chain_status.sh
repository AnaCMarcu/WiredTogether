...
#
# Usage:
#   bash hpc/delft_blue/check_chain_status.sh
#   SEED=123 bash hpc/delft_blue/check_chain_status.sh
#   EXP_ID=exp0_long NUM_CHUNKS=5 bash hpc/delft_blue/check_chain_status.sh
#
# Status legend:
