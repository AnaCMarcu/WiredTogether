...
# hpc/delft_blue/exp0_chunk.sh, so the 5 chunks form one continuous 40k-step run.
...
#
# Usage (login node):
#   bash hpc/delft_blue/experiments/exp0_long.sh
#   SEED=123 bash hpc/delft_blue/experiments/exp0_long.sh
#   bash hpc/delft_blue/experiments/exp0_long.sh --dry-run
#
...
#   python hpc/delft_blue/aggregate_seeds.py \
...
WORKER="$PROJECT_DIR/hpc/delft_blue/exp0_chunk.sh"
