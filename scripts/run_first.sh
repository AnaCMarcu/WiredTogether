...
# ── First job of a multi-job checkpoint chain ────────────────────────────────
#
# Runs the experiment from scratch and saves periodic checkpoints.
# After this job completes (or is preempted), run run_continue.sh to resume.
#
# Usage:
#   sbatch scripts/run_first.sh
#
# To chain automatically, use chain_jobs.sh instead.
# ─────────────────────────────────────────────────────────────────────────────
