...
# Submit:  sbatch scripts/experiments/exp5_ippo.sh

source "/scratch/acmarcu/WiredTogether/scripts/experiments/_common.sh"

# IPPO — action-level PPO with PER-AGENT independent value heads.
# No shared critic, no Hebbian. The "no centralized info" baseline.
# Tag-driven run dir: runs/legacy/exp5_ippo/seed_42/
