...
#
# Mirrors daic/experiments/submit_all.sh — same flags, same filtering
...
#
#   SKIP="exp9_,exp11_" bash scripts/experiments/submit_all.sh
#       — submit everything except these.
#
#   DRY_RUN=1 bash scripts/experiments/submit_all.sh
#       — print the sbatch command for each experiment without submitting.
#         Sanity check before burning N × 36h of GPU.
#
#   WANDB=0 bash scripts/experiments/submit_all.sh
...
#     SEED=123 sbatch scripts/experiments/exp4_mappo_hebbian.sh
